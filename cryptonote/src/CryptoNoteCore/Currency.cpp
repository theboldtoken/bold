...
bool Currency::generateGenesisBlock() {
  ...
  std::string genesisCoinbaseTxHex = "010a01ff000180c2d72f02408e6894770bdcf611ad2d4f5c3f725caf68049abe48904c585eb52169e7a1462101c0f966ca7ee659ea78eb346eed4161a37d8eb2c5914c12faa5c96d346c949643";
...
bool Currency::getBlockReward(uint8_t blockMajorVersion, size_t medianSize, size_t currentBlockSize, uint64_t alreadyGeneratedCoins,
  ...
  uint64_t phase1 = 550000000000000; // 5.5M BOLD
  uint64_t phase2 = 580000000000000; // 5.8M BOLD
  uint64_t phase3 = 600000000000000; // 6M BOLD
  
  if (alreadyGeneratedCoins == 100000000) {
	baseReward = 380196800000000; // premine + swap amount
  }
  
  if (alreadyGeneratedCoins >= phase1 && alreadyGeneratedCoins <= phase2) {    
      baseReward = ((m_moneySupply - alreadyGeneratedCoins) >> m_emissionSpeedFactor) / 2; // halve baseReward
  }
  
  if (alreadyGeneratedCoins > phase2  && alreadyGeneratedCoins <= phase3) {
      baseReward = ((m_moneySupply - alreadyGeneratedCoins) >> m_emissionSpeedFactor) * 2; // Bold Bonus - double baseReward
  }
  ...
  if (baseReward < subsidyTarget) {
	  baseReward = subsidyTarget; // Subsidy 0.02 BOLD
  }
