...
const char COMMUNITY_FORUM_URL[] = "https://discord.gg/9YYxZXb";
const char REPORT_ISSUE_URL[] = "https://discord.gg/9YYxZXb";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Bold Wallet %1").arg(Settings::instance().getVersion()));
