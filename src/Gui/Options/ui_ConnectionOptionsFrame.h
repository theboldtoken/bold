...
public:
    ...
    void retranslateUi(QFrame *ConnectionOptionsFrame)
    {
        ...
        m_autoHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local Bold daemon process on port 39565. In case of no local daemon running it will use an in-wallet embedded node implementation.", 0));
        ...
        m_localHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to local Bold daemon process. Please specify daemon's port.", 0));
        ...
        m_remoteHelperLabel->setText(QApplication::translate("ConnectionOptionsFrame", "Wallet will connect to Bold node running on another PC in the local or global network. Please specify IP address or domain name and the port.", 0));
    } // retranslateUi
