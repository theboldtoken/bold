...
public:
    ...
    void retranslateUi(QFrame *PrivacyFrame)
    {
        ...
        m_newsCheck->setText(QApplication::translate("PrivacyFrame", "I want to see Bold Blog feeds", 0));
        m_embeddedHelperLabel->setText(QApplication::translate("PrivacyFrame", "Checking this box will result in updated Overview screen. It will now show you the latest posts of Bold Blog providing you with fresh Bold news.", 0));
    } // retranslateUi
