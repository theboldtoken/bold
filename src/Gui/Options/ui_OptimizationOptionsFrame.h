...
public:
    ...
    void retranslateUi(QFrame *OptimizationOptionsFrame)
    {
        ...
        m_helpLabel->setText(QApplication::translate("OptimizationOptionsFrame", "Wallet optimization is a background task performed in order to aggregate transactions outputs that are below optimization target into bigger ones. It makes it cheaper to send larger amounts of BOLD within one transaction.\n"
