...
public:
    ...
    void retranslateUi(QFrame *DonationOptionsFrame)
    {
        ...
        m_donationMiningCommentLabel->setText(QApplication::translate("DonationOptionsFrame", "Donation mining allows you to contribute a fixed share of your in-wallet mining profit to a Bold address of you choice.", 0));
